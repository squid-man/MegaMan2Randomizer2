...
namespace MM2Randomizer.Extensions
{
    public static class IntegerExtensions
    {
        ...
        public static String ToAlphaBase26(this UInt32 in_Value)
        {
            const String DIGITS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
            const UInt32 RADIX = 26;
            ...
            UInt32 currentNumber = in_Value;

            while (currentNumber > 0)
            {
                UInt32 remainder = currentNumber % RADIX;
        ...
        public static String ToAlphaBase26(this Int64 in_Value)
        {
            const String DIGITS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
            const Int64 RADIX = 26;
            ...
            Int64 currentNumber = Math.Abs(in_Value);

            while (currentNumber > 0)
            {
                Int64 remainder = currentNumber % RADIX;
