...
namespace MM2Randomizer.Resources.SpritePatches
{
    public static class BossSpriteRandomizer
    {
        ...
        private static readonly List<Byte[]?> BOSS_SPRITE_LIST_WILY = new List<Byte[]?>()
        {
            ...
            Properties.BossSpriteResources.Wily_MegaMan1,
        ...
        {
            null,
            Properties.BossSpriteResources.Alien_Casino,
            ...
            Properties.BossSpriteResources.Alien_Wily,
        };
        ...
        private static readonly List<Byte[]?> BOSS_SPRITE_LIST_BOSS_DOOR_SIGN = new List<Byte[]?>()
        {
            ...
            Properties.BossSpriteResources.BossDoorSign_BreakMan,
            ...
            Properties.BossSpriteResources.BossDoorSign_ComicSans,
            Properties.BossSpriteResources.BossDoorSign_CutMansBadScissorsDay,
            Properties.BossSpriteResources.BossDoorSign_DocRobot,
            ...
            Properties.BossSpriteResources.BossDoorSign_MegaManMugshot,
            Properties.BossSpriteResources.BossDoorSign_Metroid,
            Properties.BossSpriteResources.BossDoorSign_Mikey,
            Properties.BossSpriteResources.BossDoorSign_MM3ProtoMan,
            Properties.BossSpriteResources.BossDoorSign_MM5ProtoMan,
            Properties.BossSpriteResources.BossDoorSign_MM7Metool,
            Properties.BossSpriteResources.BossDoorSign_MM7Reggae,
            Properties.BossSpriteResources.BossDoorSign_MM7Wily,
            Properties.BossSpriteResources.BossDoorSign_MM7Wily2,
            ...
            Properties.BossSpriteResources.BossDoorSign_Roll,
            Properties.BossSpriteResources.BossDoorSign_Shredder,
            Properties.BossSpriteResources.BossDoorSign_Shrek,
            Properties.BossSpriteResources.BossDoorSign_SiberianBull,
            Properties.BossSpriteResources.BossDoorSign_SigmaLogo,
            Properties.BossSpriteResources.BossDoorSign_SigmaLogoMugshotHybrid,
            Properties.BossSpriteResources.BossDoorSign_SigmaMugshot,
